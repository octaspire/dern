...
EnDoFmEsSaGe
echoToDefs
echoAndRun $CC -O2 -std=c99 -Wall -Wextra -fPIC -I . -I /usr/local/include -c plugins/dern_socket.c
...
EnDoFmEsSaGe
echoToDefs
echoAndRun $CC -O2 -std=c99 -Wall -Wextra -fPIC -I . -I /usr/local/include -c plugins/dern_dir.c
...
7. Building the 'dern_ncurses' (binary) plugin.  PLEASE NOTE: This plugin
   ...
   install development version of library 'ncurses'.
-------------------------------------------------------------------------------
EnDoFmEsSaGe
echoToDefs
