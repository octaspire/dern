...
printf "%b8)%b DYLD_LIBRARY_PATH=. ./octaspire-dern-repl examples/dern-sdl2-example.dern\n" $YELLOW $GREEN
printf "%b9)%b DYLD_LIBRARY_PATH=. ./octaspire-dern-repl examples/irc-client.dern\n" $YELLOW $GREEN
echo "=================================================================="
echoToDefs
