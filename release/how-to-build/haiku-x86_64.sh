...
echoAndRun "$CC" -O2 -std=c99 -Wall -Wextra -fPIC -shared -I . -o libdern_socket.so plugins/dern_socket.c -L/system/lib -lnetwork
...
EXAMPLE_ERROR_HINT="Install $CC compiler?"
EXAMPLE_SUCCESS_RUN="LIBRARY_PATH=\$LIBRARY_PATH:. ./octaspire-dern-repl examples/dern-easing-example.dern"
...
EXAMPLE_ERROR_HINT="Install $CC compiler?"
EXAMPLE_SUCCESS_RUN="LIBRARY_PATH=\$LIBRARY_PATH:. ./octaspire-dern-repl examples/dern-animation-example.dern"
...
EXAMPLE_ERROR_HINT="Install $CC compiler?"
EXAMPLE_SUCCESS_RUN="LIBRARY_PATH=\$LIBRARY_PATH:. ./octaspire-dern-repl examples/dern-chipmunk-example.dern"
