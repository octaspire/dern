...
Documentation for Octaspire Dern programming language version 0.213.10
...
DragonFly BSD, MidnightBSD, MINIX 3, Haiku, Windows and macOS. The `how-to-build`-directory of
...
*haiku.sh*, *SyllableDesktop.sh* or *macOS.sh*.
