...
Documentation for Octaspire Dern programming language version 0.300.2
...
OpenIndiana, DragonFly BSD, MidnightBSD, MINIX 3, Haiku, Windows, ReactOS, macOS and Termux.
...
*haiku.sh*, *SyllableDesktop.sh*, *macOS.sh* or *termux.sh*.
