...
Documentation for Octaspire Dern programming language version 0.109.0
...
replace *YOUR_PLATFORM_NAME_HERE.XX* with *FreeBSD.sh*, *NetBSD.sh*, *linux.sh*, *minix3.sh*
or *haiku.sh*. More scripts for different platforms will be added later.
