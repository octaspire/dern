...
Documentation for Octaspire Dern programming language version 0.140.0
...
release contains build script for all tested platforms.
...
*DragonFlyBSD.sh*, *linux.sh*, *minix3.sh* or *haiku.sh*. More scripts for different platforms will
be added later.
