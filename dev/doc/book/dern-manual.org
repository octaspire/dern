...
(2) interactive Dern-REPL and (3) used as single header file library in programs that want
...
Plan9, Syllable Desktop, AROS and Amiga.
...
*** Other systems and building the documentation
...
If you want to build the documentation, you should also install *Emacs 25.x* or newer.

This is all there should be to it; *octaspire core* and *octaspire_dotfiles* are included as
git submodules. Note that at the moment, to be able to build the documentation, you must
have the octaspire_dotfiles in use in your system (the submodule for the dotfiles is not used
at the moment) and Emacs 25.x or newer installed.
